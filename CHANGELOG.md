...
- A landing page at <https://alexnodeland.github.io/sleeve/>, published from
  `site/` by CI. One self-contained HTML file with no external requests; the
  deploy workflow fails if that ever stops being true.
